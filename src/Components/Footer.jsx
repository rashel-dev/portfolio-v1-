                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                      ...
                      <motion.div variants={itemVariants} className="space-y-4">
                          ...
                          <p className="text-gray-600 dark:text-gray-300 text-sm">
                              Passionate MERN Stack Developer shaping seamless user experiences. Clean code, elegant UI, and performance-driven development.
                          </p>
                          ...
                          <ul className="space-y-3">
                              {contactInfo.map((info, index) => (
                                  <motion.li key={index} className="flex items-start space-x-3 text-sm" whileHover={{ scale: 1.02 }}>
                                      ...
                                      {info.href ? (
                                          <a href={info.href} className="hover:text-gray-900 dark:hover:text-white transition-colors duration-300 text-gray-600 dark:text-gray-300">
                                              {info.text}
                                          </a>
                                      ) : (
                      ...
                      <motion.div variants={itemVariants} className="space-y-4">
                          ...
                          <p className="text-gray-600 dark:text-gray-300 text-sm">Subscribe to get updates on my latest work.</p>
